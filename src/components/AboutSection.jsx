      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-11 items-center text-left">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Also, I am a sustainability consultant and I consult organisations
              on developing and implementing strategies to reduce their
              environmental impact, improve resource efficiency, and achieve
